...
- Start by searching in slack history, Notion, linear, gitlab/github, email, or dropbox documentation - invest at least 2 minutes in each.
...
- linear issue, so information can be shared
...
- sms, if urgent
  - you can generally find a person's phone number in Notion or the [slack directory][slack-directory]
...
- excercise good time management
  ...
  - The only person who *has* to respond to any question in less than an hour is @davidbarinas
...
- If you have a linear issue that needs attention, send via email to the people involved and request an `[ack]`
...
- If there is no linear issue, there is no problem. Ask for the creation of one or make it yourself.
...
- If you'll be unavailable (unreachable) for 1 or more hours during 10 - 6 NYC:
  ...
  - send an email to david@valiu.co informing the change with at least 24hrs notice and who is covering you
...
- If you'll be traveling, working remote, or taking time off:
  - make sure someone can cover you, or knows where to find you in case of downtime or urgent issue
  - send an email to dev@valiu.co at least 1 week in advance, and where to find you in case of downtime or urgent issue
  - add it to the [Availibility Calendar][availz-cal]
...
[ride-org]: https://gitlab.com/valiuapp
[ride-product-org]: https://github.com/valiuapp
[support-waffle]: https://waffle.io/
[slack-directory]: https://valiu.slack.com/team
...
[availz-cal]: https://calendar.google.com/calendar/r
